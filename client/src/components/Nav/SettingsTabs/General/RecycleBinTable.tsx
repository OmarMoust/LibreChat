...
export default function RecycleBinTable({
  ...
  const deleteMutation = useDeleteConversationMutation({
    onSuccess: async () => {
      ...
      await refetch();
      showToast({
        message: localize('com_ui_convo_permanent_delete_success'),
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex items-center gap-2">
              ...
              />
              <TooltipAnchor
                description={localize('com_ui_delete_permanently')}
                render={
                  <Button
                    variant="ghost"
                    className="h-8 w-8 p-0 hover:bg-surface-hover"
                    ...
                    title={localize('com_ui_delete_permanently')}
                    aria-label={localize('com_ui_delete_permanently')}
                  >
      ...
      <OGDialog open={isDeleteOpen} onOpenChange={onOpenChange}>
        ...
        >
          <OGDialogHeader>
            <OGDialogTitle>
              <Trans
                i18nKey="com_ui_permanent_delete_confirm_strong"
          ...
          <div className="flex justify-end gap-4 pt-4">
            ...
            >
              {deleteMutation.isLoading ? <Spinner /> : localize('com_ui_delete_permanently')}
            </Button>
          </div>
        </OGDialogContent>
      </OGDialog>
